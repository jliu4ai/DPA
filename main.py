...
if __name__ == '__main__':
    ...
    #data
    parser.add_argument('--phase', type=str, default='eval', choices=['pretrain', 'train', 'eval'])
    ...
    parser.add_argument('--pretrain_checkpoint_path', type=str, default='./log_s3dis/log_pretrain_s3dis_S0/',
    ...
    parser.add_argument('--use_high_dgcnn', type=bool, default=True, help='high dgcnn')
    parser.add_argument('--use_linear_proj', type=bool, default=True, help='use linear projection for feature')
    ...
    parser.add_argument('--run', type=int, default=0, help='order of run')
    ...
    # Start trainer for pre-train, train, eval
    if args.phase=='pretrain':
        ...
        args.log_dir = args.save_path + \
                       'log_train_%s_S%d_N%d_K%d_Att%d' % (args.dataset, args.cvfold, args.n_way,
                                                           args.k_shot, args.use_attention)
