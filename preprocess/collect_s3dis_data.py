...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='/home/jie/1A_Code/PointCloud/FSPS/Datasets/Stanford3dDataset_v1.2_Aligned_Version',
    ...
    DST_PATH = os.path.join('/home/jie/1A_Code/PointCloud/FSPS/attMPTI/datasets', 'S3DIS')
    SAVE_PATH = os.path.join(DST_PATH, 'scenes', 'data')
    if not os.path.exists(SAVE_PATH): os.makedirs(SAVE_PATH)

    CLASS_NAMES = [x.rstrip() for x in open(os.path.join('/home/jie/1A_Code/PointCloud/FSPS/attMPTI/datasets', 'S3DIS/meta', 's3dis_classnames.txt'))]
