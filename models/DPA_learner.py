        ...
        if mode=='train':
            self.optimizer = torch.optim.Adam(
                [{'params': self.model.encoder.parameters(), 'lr': 0.0001},
                 ...
                 {'params': self.model.transformer1.parameters(), 'lr': 0.0001},
                 {'params': self.model.transformer2.parameters(), 'lr': 0.0001},
                 {'params': self.model.conv_1.parameters()},
